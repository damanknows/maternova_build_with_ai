...
const Dashboard = ({ setActiveSection }: DashboardProps) => {
  ...
  return (
    <div className="space-y-6 animate-fade-in relative">
      ...
      <div className="absolute top-0 right-0 z-10 p-2 md:p-6 flex items-center gap-2">
        <Globe className="w-4 h-4 text-primary" />
        <Select value={language} onValueChange={(v) => setLanguage(v as LanguageCode)}>
          <SelectTrigger className="w-[140px] bg-white/20 backdrop-blur-md border-white/30 text-foreground">
      ...
      {/* Welcome Section */}
      <div className="gradient-primary rounded-2xl p-6 md:p-8 text-primary-foreground mt-12 md:mt-0">
