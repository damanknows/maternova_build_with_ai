...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-br from-primary/30 via-transparent to-purple-500/20 backdrop-blur-sm" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-4xl animate-fade-in">
        ...
        {/* Login Card */}
        <Card className="bg-white/50 backdrop-blur-2xl shadow-elevated border border-white/50 p-8 rounded-3xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            {roleOptions.map(({ role, label, icon, description, idPrefix }) => (
              <button
                ...
                className={`p-4 rounded-2xl border-2 transition-all duration-300 text-center backdrop-blur-sm ${
                  selectedRole === role
                    ? 'border-primary bg-primary/15 shadow-soft scale-105'
                    : 'border-white/60 bg-white/30 hover:border-primary/50 hover:bg-white/50'
                }`}
              >
          ...
          {selectedRole && (
            <div className="space-y-4 animate-fade-in">
              <div className="bg-primary/10 backdrop-blur-sm rounded-xl p-3 text-sm text-primary text-center border border-primary/20">
